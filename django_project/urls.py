"""Artagram django_project URL Configuration:
...
from users.views import register, Login, Logout, profile, user_profile
from mail.views import contact_view
...
# RS: this project is still in development, so we are uploading the media files from MEDIA_ROOT.
if settings.DEBUG:
